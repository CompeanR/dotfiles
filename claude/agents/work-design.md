---
name: work-design
description: Design a routine implementation directly from an inline brief. Use for read-only, implementation-ready design of a scoped change before editing.

...
5. In apply mode, edit only safe issues, preserve content, create supporting files when needed, then rebuild `.atl/skill-registry.md` by following the installed `skill-registry` skill.
